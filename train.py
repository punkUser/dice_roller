...
def main():
	...
	train_set = torchvision.datasets.ImageFolder(root=os.path.join("training_data", DATA), transform=train_transform)
	...
	test_set = torchvision.datasets.ImageFolder(root=os.path.join("test_data", DATA), transform=test_transform)	
	...
	raw_train_set = torchvision.datasets.ImageFolder(root=os.path.join("training_data", DATA), transform=test_transform)
